var student = [
  { name: "Banu Priya", date: "15-03-2005", tamil: 32, english: 84, maths: 89, science: 89, social: 87 },
  { name: "Banu Priya", date: "05-03-2005", tamil: 90, english: 84, maths: 89, science: 89, social: 87 },
  { name: "Charan Raj", date: "30-11-2005", tamil: 76, english: 70, maths: 80, science: 15, social: 73 },
...
for (let i = 0; i < arrLenth; i++) {
  const s = student[i];
  console.log(`Name: ${s.name}, Total: ${s.total}, Rank: ${s.rank},Date: ${s.date},Result: ${s.result}`);
}
